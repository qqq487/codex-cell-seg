...
#dir_img = Path('./data/org/')
#dir_mask = Path('./data/org/')
#dir_checkpoint = Path('./checkpoints_norm_aug_batch_4/')
...
def train_net(net,
    ...
    dir_img = Path(os.path.join(data_root,'imgs')) ## './data/multi-org-same-ch/imgs'
    dir_mask = Path(os.path.join(data_root,'masks')) ## './data/multi-org-same-ch/masks'
